...
def train(model_SNet, model_TNet, loader, optimizer, loss_fn):
    ...
    for x, y in loader:
        ...
        conv_reduce_channels = nn.Conv2d(1024, 64, kernel_size=1).to(device)
        ...
        conv_reduce_channels2 = nn.Conv2d(128, 32, kernel_size=1).to(device)
...
if __name__ == "__main__":
    ...
    """ Directories """
    create_dir("Modelfiles_KD_E-E+B-B+D-D+PMD")
    ...
    num_epochs = 120
    lr = 1e-2
    checkpoint_path = r'D:\Risab\Thesis_Experiment_v2\Spleen_KD_Student_(SmallerUNet)\Modelfiles_KD_E-E+B-B+D-D+PMD\E-E+B-B+D-D+PMD_Checkpoint.pth'
    ...
    for epoch in range(num_epochs):
        ...
        plt.legend()
        plt.savefig('Training_Curve_KD_E-E+B-B+D-D+PMD.png')
