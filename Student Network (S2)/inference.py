...
# Paths to test data
test_x = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_Seg_Student_v2\test_data\image\*'))
test_y = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_Seg_Student_v2\test_data\mask\*'))
