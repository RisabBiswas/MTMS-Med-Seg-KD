...
# Paths
predicted_mask_folder = r'D:\Risab\Thesis_Experiment_v2\Spleen_KD_Student_(SmallerUNet)_T2_S2\predicted_mask_KD_B-B+PMD'
ground_truth_mask_folder = r'D:\Risab\Thesis_Experiment_v2\Spleen_KD_Student_(SmallerUNet)_T2\test_data\mask'
...
print(f"Dice Coefficient: {dice}")  # Print Dice coefficient