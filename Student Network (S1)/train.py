...
if __name__ == "__main__":
    ...
    """ Directories """
    create_dir("Model_Weights_Student")

    """ Load dataset """
    train_x = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_Seg_Student\train_data\image\*'))
    train_y = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_Seg_Student\train_data\mask\*'))

    valid_x = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_Seg_Student\test_data\image\*'))
    valid_y = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_Seg_Student\test_data\mask\*'))
