...
def train(model_SNet, model_TNet, loader, optimizer, loss_fn):
    ...
    for x, y in loader:
        ...
        conv_reduce_channels = nn.Conv2d(512, 64, kernel_size=1).to(device)
        ...
        loss = seg_loss * seg_loss_weight + loss_decoder * d_d_con_loss_weight + loss_P2 * e_e_con_loss_weight + b_b_Con_loss * b_b_Con_loss_weight + loss_pmd * pmd_loss_weight
        loss.backward()
        optimizer.step()
...
if __name__ == "__main__":
    ...
    num_epochs = 120
    lr = 1e-2
    checkpoint_path = r'D:\Risab\Thesis_Experiment_v2\Spleen_KD_Student_(SmallerUNet)_T2\Modelfiles_KD_B-B+E-E+D-D+PMD\KD_B-B+E-E+D-D+PMD_Checkpoint.pth'
    ...
    checkpoint_dir = r'D:\Risab\Thesis_Experiment_v2\Spleen_KD_Student_(SmallerUNet)_T2\Model_Weights_MultiTask'
