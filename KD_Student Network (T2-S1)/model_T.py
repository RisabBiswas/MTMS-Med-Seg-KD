...
class MultiTask_U_Net(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return b, p2, d4_seg, segmentation_output, reconstruction_output

if __name__ == "__main__":
    x = torch.randn((2, 3, 512, 512))
    f = MultiTask_U_Net()
    segmentation_output, reconstruction_output = f(x)
    print("Segmentation Output Shape:", segmentation_output.shape)
    print("Reconstruction Output Shape:", reconstruction_output.shape)
