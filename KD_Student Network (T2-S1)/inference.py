...
# Paths to test data
test_x = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_KD_Student_(SmallerUNet)\test_data\image\*'))
test_y = sorted(glob(r'D:\Risab\Thesis_Experiment_v2\Spleen_KD_Student_(SmallerUNet)\test_data\mask\*'))
...
output_folder = "predicted_mask_KD_B-B+E-E+D-D+PMD"
