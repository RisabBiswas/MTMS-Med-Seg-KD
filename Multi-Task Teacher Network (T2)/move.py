...
if __name__ == "__main__":
    ...
    source_folder = r'D:\Risab\Medical_Experiments\Spleen_TransUNet\predicted_output_dekhi'
    destination_folder = r'D:\Risab\Medical_Experiments\Spleen_TransUNet\all_preds'
