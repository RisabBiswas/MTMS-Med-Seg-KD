...
if __name__ == "__main__":
    ...
    """ Load dataset """
    train_x_Seg = sorted(glob(r'D:\Risab\Medical_Experiments\Spleen_MultiTask\train_data\image\*'))
    train_y_Seg = sorted(glob(r'D:\Risab\Medical_Experiments\Spleen_MultiTask\train_data\mask\*'))

    valid_x_Seg = sorted(glob(r'D:\Risab\Medical_Experiments\Spleen_MultiTask\test_data\image\*'))
    valid_y_Seg = sorted(glob(r'D:\Risab\Medical_Experiments\Spleen_MultiTask\test_data\mask\*'))

    train_x_Recon = sorted(glob(r'D:\Risab\Medical_Experiments\Spleen_MultiTask\train_data\image\*'))
    train_y_Recon = train_x_Recon

    valid_x_Recon = sorted(glob(r'D:\Risab\Medical_Experiments\Spleen_MultiTask\test_data\image\*'))
    ...
    num_epochs = 200
    lr = 1e-4
    checkpoint_path = r'D:\Risab\Medical_Experiments\Spleen_MultiTask\Model_Weights_MultiTask\MultiTask_checkpoint_v1.pth'
    ...
    model = build_unet(num_classes_segmentation=1, num_channels_reconstruction=3)
