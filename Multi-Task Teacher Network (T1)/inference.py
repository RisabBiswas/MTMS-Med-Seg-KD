...
model = build_unet(num_classes_segmentation=1, num_channels_reconstruction=3).to(device)  # Replace with the actual model instantiation code
checkpoint_dir = r'D:\Risab\Medical_Experiments\Spleen_MultiTask\Model_Weights_MultiTask'
